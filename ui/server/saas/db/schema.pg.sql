-- PD-SAAS-FORK: PostgreSQL reference schema (authoritative migrations in migrations/)
...
-- PD-SAAS-FORK: tombstone for orphan transcripts after hardDelete (see migrations/002_session_tombstones.sql)

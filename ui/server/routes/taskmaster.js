...
router.get('/installation-status', async (req, res) => {
    try {
        const { taskmasterStatusKey } = await import('../saas/cache/cacheKeys.js');
        const { cacheGet, cacheSet, getDefaultTtl } = await import('../saas/cache/redisClient.js');
        const cacheKey = taskmasterStatusKey();
        ...
        void cacheSet(cacheKey, responseBody, getDefaultTtl('taskmaster'));

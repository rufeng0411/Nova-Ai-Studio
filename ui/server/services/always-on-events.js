...
// PD-SAAS-FORK: keep only events whose projectKey belongs to the caller's tenant.
...
export async function getAlwaysOnDashboardEvents(opts = {}) {
    ...
    // PD-SAAS-FORK: tenant isolation — drop events from other tenants' projects.
    let filtered = filterByTenantProjectKey(allEvents);

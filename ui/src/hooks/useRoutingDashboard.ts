...
export type UsageDashboardScope = 'me' | 'system';

export function useRoutingDashboard(scope: UsageDashboardScope = 'me') {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      const query = scope === 'system' ? '?scope=system' : '?scope=me';

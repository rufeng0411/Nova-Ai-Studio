...
export default function ShellConnectionOverlay({
 ...
 <div className="text-primary-foreground">{loadingLabel}</div>
 </div>
 );
 }
 ...
 <button
 onClick={onConnect}
 className="flex w-full items-center justify-center space-x-2 rounded-lg bg-green-600 px-6 py-3 text-base font-medium text-primary-foreground transition-colors hover:bg-green-700 sm:w-auto"
 title={connectTitle}
 >

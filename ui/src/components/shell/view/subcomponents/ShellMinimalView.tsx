...
export default function ShellMinimalView({
 ...
 className="flex-1 rounded bg-blue-600 px-3 py-2 text-xs font-medium text-primary-foreground hover:bg-blue-700"
 >
 Open URL
 </button>
 ...
 className="flex-1 rounded bg-gray-700 px-3 py-2 text-xs font-medium text-primary-foreground hover:bg-gray-600"
 >

...
export default function ShellHeader({
 ...
 className="flex items-center space-x-1 rounded bg-red-600 px-3 py-1 text-xs text-primary-foreground hover:bg-red-700"
 ...
 className="flex items-center space-x-1 text-xs text-gray-400 hover:text-primary-foreground disabled:cursor-not-allowed disabled:opacity-50"
 title={restartTitle}
 >
 <svg className="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0">
 <path

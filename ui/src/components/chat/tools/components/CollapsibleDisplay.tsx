...
export const CollapsibleDisplay: React.FC<CollapsibleDisplayProps> = ({
 ...
 <summary className="flex cursor-pointer items-center gap-1.5 py-0.5 text-[11px] text-gray-400 hover:text-muted-foreground dark:text-gray-500 dark:hover:text-gray-300">
 <svg
 ...
 {t('toolDisplay.rawParams', { defaultValue: 'Raw parameters' })}
 </summary>
 <pre className="mt-1 overflow-hidden whitespace-pre-wrap break-words rounded border border-border/40 bg-muted p-2 font-mono text-[11px] text-muted-foreground dark:border-gray-700/40 dark:bg-popover/50">
 {rawContent}
 </pre>
 </details>
 )}

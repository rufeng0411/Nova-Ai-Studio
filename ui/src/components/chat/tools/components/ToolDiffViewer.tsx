...
export const ToolDiffViewer: React.FC<ToolDiffViewerProps> = ({
 ...
 : 'bg-muted dark:bg-card text-gray-500 ';
 ...
 return (
 <div className="overflow-hidden rounded border border-border/60 dark:border-gray-700/50">
 {/* Header */}
 <div className="flex items-center justify-between border-b border-border/60 bg-muted/80 px-2.5 py-1 dark:border-gray-700/50 dark:bg-card/40">
 {onFileClick ? (
 <button
 onClick={onFileClick}
 className="cursor-pointer truncate font-mono text-[11px] text-blue-600 transition-colors hover:text-info dark:text-blue-400 dark:hover:text-blue-300"
 >
 {safeFilePath}
 </button>
 ) : (

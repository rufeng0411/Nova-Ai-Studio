...
export const OneLineDisplay: React.FC<OneLineDisplayProps> = ({
 ...
 wrapText = false,
 colorScheme = {
 primary: 'text-foreground dark:text-gray-300',
 ...
 className="ml-1 flex-shrink-0 text-gray-400 opacity-0 transition-all hover:text-muted-foreground group-hover:opacity-100 dark:hover:text-gray-200"
 title={t('clipboard.copy')}
 aria-label={t('clipboard.copy')}
 >
 {copied ? (
 <svg className="h-3 w-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0">
 ...
 <svg className="h-3 w-3 text-green-500 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
 </svg>
 </div>
 <div className="flex min-w-0 flex-1 items-start gap-2">
 <div className="min-w-0 flex-1 rounded bg-popover px-2.5 py-1 dark:bg-black">
 ...
 <span className="flex-shrink-0 text-xs text-gray-500">{label || toolName}</span>
 <span className="text-[10px] text-gray-300">/</span>
 <button
 onClick={handleAction}
 className="truncate font-mono text-xs text-blue-600 transition-colors hover:text-info hover:underline dark:text-blue-400 dark:hover:text-blue-300"
 title={value}
 >
 {displayName}
 </button>
 ...
 className="flex flex-shrink-0 items-center gap-0.5 text-[11px] text-blue-600 transition-colors hover:text-info dark:text-blue-400 dark:hover:text-blue-300"
 >
 <svg className="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0">

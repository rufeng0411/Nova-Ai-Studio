...
const MessageCopyControl = ({
 ...
 ? 'text-blue-100 hover:text-primary-foreground'
 : 'text-gray-400 hover:text-muted-foreground dark:text-gray-500 dark:hover:text-gray-300';
 ...
 {isDropdownOpen && (
 <div className="absolute left-auto top-full z-30 mt-1 min-w-36 rounded-md border border-border bg-card p-1 shadow-lg dark:border-gray-700 dark:bg-popover">
 ...
 : 'text-foreground hover:bg-muted dark:text-gray-300 dark:hover:bg-card/60'
 }`}
 >

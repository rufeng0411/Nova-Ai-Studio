...
export interface ChatMessage {
  ...
  /** User bubble echoing ask_user_question / plan elicitation selections. */
...
export interface ChatInterfaceProps {
  ...
  onExecutionStatusChange?: (payload: {
    sessionId: string;
    executionStatus: import('../../../types/app').ProjectSession['executionStatus'];
    pausedReason?: string | null;
    queuePosition?: number | null;
  }) => void;
  /** PD-SAAS-FORK: sync sidebar attention icons (needs reply / interrupted). */
  onSessionAttentionChange?: (
    sessionId: string,
    attention: import('../../shared/sessionSidebarAttention').SessionSidebarAttention,
  ) => void;
  ...
  onExitWelcome?: () => void;
  /** Open the capability discover tab from welcome suggestions. */
  onOpenDiscoverTab?: () => void;
  /** Start a fresh chat session (for capability / process template try-it). */
  onStartNewSession?: (project: import('../../../types/app').Project) => void;
}

// PD-SAAS-FORK: workspace path field with folder picker (OSS wizard)
...
import PathFolderPickerDialog from '../../../shared/path-picker/PathFolderPickerDialog';
import { rememberRecentPath } from '../../../shared/path-picker/recentPaths';
 ...
 [onChange],
  ...
  const handleFolderSelected = useCallback(
    (selectedPath: string, advanceToConfirm: boolean) => {
      rememberRecentPath(selectedPath);

...
export default function LoginForm() {
 ...
 footerText="Enter your credentials to access Nova Ai-Studio"
 logo={
 <div className="flex items-center justify-center">
 <img
 src={novaLogoMark}
 alt="Nova Ai-Studio"
 className="h-10 w-auto max-w-[3.25rem] select-none object-contain"
 draggable={false}
 />
 </div>
 }
 ...
 className="w-full rounded-md bg-blue-600 px-4 py-2 font-medium text-primary-foreground transition-colors duration-200 hover:bg-blue-700 disabled:bg-blue-400"
 >

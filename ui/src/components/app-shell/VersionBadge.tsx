...
export function VersionBadge() {
 ...
 document.title = 'Restarting Nova Ai-Studio...';
 ...
 <svg style="width:40px;height:40px;margin-bottom:16px;animation:spin 1s linear infinite" viewBox="0 0" fill="none" stroke="#888" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.22-8.56"/></svg>
 <p style="color:#ccc;font-size:1.1rem;margin:0 0 8px">Restarting Nova Ai-Studio...</p>
 ...
 info.hasUpdate
 ? 'bg-blue-100 text-info hover:bg-blue-200 dark:bg-blue-900/40 dark:hover:bg-blue-900/60'
 ...
 {info.hasUpdate && (
 <span className="ml-0.5 h-1.5 w-1.5 rounded-full bg-primary dark:bg-primary" />
 )}
 </button>
 ...
 <li
 key={i}
 className="truncate text-xs font-mono text-info"
 >
 {commit}
 </li>
 ))}
 ...
 <div className="max-h-40 overflow-y-auto rounded bg-primary p-2">
 {logs.map((line, i) => (
 ...
 {logs.length > 0 && (
 <div className="max-h-32 overflow-y-auto rounded bg-primary p-2 mt-2">
 ...
 disabled={loading}
 className="inline-flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50 dark:bg-primary dark:hover:bg-primary"
 >
 ...
 className="inline-flex items-center gap-1.5 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600"
 >
 <RefreshCw className="h-3.5 w-3.5" />
 Restart to Apply
 </button>

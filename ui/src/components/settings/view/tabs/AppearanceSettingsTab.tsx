...
import HtmlStudioSettingsRow from '../sections/HtmlStudioSettingsRow';
import HfStudioSettingsRow from '../sections/HfStudioSettingsRow';
...
export default function AppearanceSettingsTab({
 ...
 <SettingsSection title={t('appearanceSettings.designCanvas.section', { defaultValue: '创作扩展' })}>
 <SettingsCard>
 <DesignCanvasSettingsRow />
 <HtmlStudioSettingsRow />
 <HfStudioSettingsRow />
 </SettingsCard>
 </SettingsSection>

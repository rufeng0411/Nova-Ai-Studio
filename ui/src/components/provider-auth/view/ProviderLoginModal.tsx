...
const getProviderTitle = (provider: CliProvider) => {
 if (provider === 'pilotdeck') return 'Nova Ai-Studio API Login';
...
export default function ProviderLoginModal({
 ...
 <h3 className="text-lg font-semibold text-gray-900 dark:text-primary-foreground">{title}</h3>
 <button
 onClick={onClose}
 ...
 <h4 className="mb-3 text-xl font-medium text-gray-900 dark:text-primary-foreground">Setup Gemini API Access</h4>
 ...
 <div>
 <p className="mb-1 text-sm font-medium text-gray-900 dark:text-primary-foreground">Get your API key</p>
 <a
 ...
 <div>
 <p className="mb-1 text-sm font-medium text-gray-900 dark:text-primary-foreground">Run configuration</p>
 ...
 <button
 onClick={onClose}
 className="mt-8 rounded-lg bg-blue-600 px-6 py-2.5 font-medium text-primary-foreground transition-colors hover:bg-blue-700"
 >
 Done
 </button>
 </div>

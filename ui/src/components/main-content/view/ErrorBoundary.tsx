...
function ErrorFallback({
 ...
 <svg className="h-5 w-5 text-red-400" viewBox="0 0" fill="currentColor">
 <path
 fillRule="evenodd"
 ...
 className="rounded bg-red-600 px-4 py-2 text-sm text-primary-foreground hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
 >
 Try Again
 </button>
 </div>

...
الاستخدامات المناسبة: عروض استشارية عالية الكثافة، مثل أبحاث القطاعات، تحليل المستهلك، استراتيجية العلامة التجارية، تحليل التجارة الإلكترونية، أبحاث المستخدمين، عروض الإدارة العليا، مواد مجالس الإدارة، عروض العملاء، ومراجعات المشاريع.

الاستخدامات غير المناسبة: عروض منخفضة الكثافة وقليلة النصوص، مثل الخطب، التعبير الشخصي، السرد، المشاركة العامة، أو عروض الآراء فقط.
...
## **طريقة الاستخدام (قراءة إلزامية!)**

**التثبيت: أعطِ Codex رابط المشروع واطلب منه تثبيت الـ Skill.**

يتكوّن إنشاء عرض PPT بصورة صحيحة من ثلاث مراحل:

**1. تحليل المواد المصدرية.**

- ارفع مستنداتك، ثم أخبر Codex بوضوح: «استخدم Skill ‏CyberPPT الموجود في المجلد XX لإنشاء عرض PPT استنادًا إلى المستندات/المواد المرفوعة»، مع إضافة أي متطلبات أخرى. في هذه المرحلة، يحلل CyberPPT المواد ويُنشئ مسودة موثقة بالأدلة.

- ملاحظة: يحلل CyberPPT المواد تلقائيًا ويحدد عدد الشرائح المطلوب. ويمكنك أيضًا تحديد عدد الشرائح بنفسك عند الحاجة.

**2. اختيار النمط وإنشاء المخططات الأولية.**

- يعرض CyberPPT ثمانية أنماط مدمجة للاختيار من بينها. بعد اختيار النمط، ينتقل إلى مرحلة إنشاء المخططات الأولية وينشئ مخططات جميع الشرائح دفعة واحدة. لا تكون هذه المخططات قابلة للتحرير في هذه المرحلة.

**3. إنشاء عرض PPT قابل للتحرير.**

- في هذه المرحلة، يعيد CyberPPT بناء المخططات الأولية شريحةً تلو الأخرى. قد يتشتت انتباه الذكاء الاصطناعي؛ فإذا بدأ بإعادة بناء جميع الشرائح دفعة واحدة، أوقفه فورًا وقل له: «اتبع الـ Skill بدقة وأعد بناء الشرائح واحدةً تلو الأخرى». وإلا فقد يختصر العمل وينتج هياكل تخطيطية فقط. إذا انحرفت شريحة عن مخططها الأولي، فأشر إلى المشكلة فور ظهورها (**تعمل لقطات الشاشة المشروحة بأسهم بأفضل صورة**). تستغرق الشريحتان الأولى والثانية عادةً وقتًا أطول وتكونان أكثر عرضة للأخطاء. يصعب تجنب هذه المعايرة في التشغيل الأول، ولكن بعد ضبط سير العمل سيصبح CyberPPT أسرع وتتحسن نتائجه تدريجيًا.

**ملاحظات أخيرة**

- المراحل الثلاث كلها إلزامية ولا يجوز تخطيها. باتباعها، يستطيع الـ Skill إعادة إنتاج نحو 90% من المخططات الأولية. تُعد الرسوم البيانية المنحنية الأصعب في إعادة البناء؛ فإذا انحرفت النتيجة، قدّم لقطة شاشة واطلب من Codex ضبطها بدقة. وقد يختار الذكاء الاصطناعي أيضًا أيقونات صغيرة غير صحيحة، لذا أشر إلى الأخطاء واطلب إعادة توليدها. يمكنك تعديل مشكلات فواصل الأسطر وأحجام الخطوط المتبقية يدويًا. تجنّب الإصرار على أن يعيد الذكاء الاصطناعي كل شيء بدقة 100%؛ فهذا ممكن، لكن النتائج تتضمن قدرًا من العشوائية — فقد تنجح من المحاولة الأولى أحيانًا، وقد تحتاج إلى عدة محاولات أحيانًا أخرى. يتطلب الوصول إلى 100% بالذكاء الاصطناعي وحده وقتًا أكبر بكثير لتصحيح الأخطاء واستهلاكًا أعلى من Token. التوصية العملية هي: **دع الذكاء الاصطناعي ينجز 90% وأكمل بنفسك الـ 10% المتبقية**؛ وإلا فيمكنك استخدام المخططات الأولية مباشرةً.

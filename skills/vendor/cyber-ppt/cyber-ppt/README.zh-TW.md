...
適用場景：顧問風格 PPT，高資訊密度，包括產業研究、消費品分析、品牌策略、電商分析、使用者研究、高階主管匯報、董事會材料、客戶提案和專案復盤。

不適用場景：字少的低資訊密度風格，包括演講、個人風格表達、敘事、分享、觀點類 PPT。

CyberPPT 的核心不是「套範本」，而是把來源材料先轉成可稽核證據鏈，再透過 SCR 論證、頁面密度規劃、視覺藍圖和嚴格門禁，生成可編輯且高保真的顧問式 PPTX。

## **使用方法（必看！）**

**安裝：將專案網址交給 Codex，讓它安裝 Skill。**

正式製作 PPT 分為三個階段：

**1. 資料分析。**

- 上傳你的資料文件，並明確告訴 Codex：「使用 XX 資料夾下的 CyberPPT 這個 Skill，根據上傳的文件／資料製作一份 PPT。」以及其他補充要求。這個階段會分析你的資料並產出證據底稿。

- 備註：CyberPPT 會自動分析並確認需要製作多少頁；如需指定頁數，也可以直接提出。

**2. 選擇風格並製作藍圖。**

- 這裡會提供 8 種內建風格供你選擇。選定後會進入藍圖生成流程，一次產出所有頁面的藍圖；此時藍圖還不能編輯。

**3. 生成可編輯的 PPT。**

- 這個階段會逐頁還原藍圖。特別要注意，AI 的注意力可能分散；如果你發現它試圖一次還原全部頁面，請立即停止並告訴它：「嚴格按照 Skill 逐頁還原。」否則它可能會偷懶，只產出骨架版面。如果逐頁還原結果與藍圖有偏差，可以在問題出現時立即指出（**使用標示箭頭的截圖效果最好**）。通常第一頁和第二頁會耗時較久，也比較容易出錯；這是第一次執行時難以避免的磨合過程，但調校完成後，它會越做越快、結果也會越來越好。

**最後說明**

- 三個階段都必須完成，不可跳過，才能讓這個 Skill 還原約 90% 的藍圖。最難還原的是曲線圖表；如果結果跑偏，可以提供截圖，請 Codex 精細調整。AI 也容易選錯小圖示，發現問題時可直接指出並要求重新生成。剩餘的換行和字級問題，可以自行編輯調整。不要強求 AI 達到 100% 完美還原：雖然做得到，但具有一定隨機性，有時一次就能完成，有時則會出現偏差。若堅持讓 AI 達到 100%，會需要更多除錯時間和 Token。實際建議是：**AI 完成 90%，剩下 10% 自己處理**；否則也可以直接使用藍圖。

...
- 审计输出写入 **`<task-artifact-dir>/geo-aeo-audit-checklist.md`**（alias: `aeo-audit.md`）；与 pd-geo 契约对齐。
- **禁止** ask_user_question 挡首文件；报告 MD 完成后 `read_skill geo-dual-report` 同步 HTML。
<!-- NOVA-EXEC-END -->

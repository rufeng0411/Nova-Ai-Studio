...
description: >-
  ...
  Nova Ai-Studio's global skills directory. Use when the user asks to migrate,
  import, copy, or consolidate skills into Nova Ai-Studio, or mentions
  ~/.claude/skills, ~/.openclaw, ~/.hermes, ~/.agents/skills, or
  ~/.pilotdeck/skills.
---

# Nova Ai-Studio Skills Migration

Use this skill to migrate Agent Skill folders into Nova Ai-Studio's global skill
...
```text
Which skills should I migrate into Nova Ai-Studio?
- Claude Code
- OpenClaw
- Hermes
- Custom path
...
The Nova Ai-Studio migrator scans immediate child directories containing `SKILL.md`
from:
...
- Prefer `--rename` over `--overwrite` unless the user explicitly wants to
  replace existing Nova Ai-Studio skills.

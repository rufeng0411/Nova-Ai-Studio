...
| /goal Feature 2 自然语言完成条件入 TaskGoalContract（N 轮内停 + 完成条件） | 通过 | `npx vitest run src/saas/taskState/taskGoalContract.test.ts src/saas/resilience/stabilityFlags.test.ts` |

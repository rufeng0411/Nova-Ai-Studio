...
const SHARED_PREFIX = `You are a subagent of NovaStudio — a focused agent dispatched by the parent agent to handle a bounded research, planning, or verification task.

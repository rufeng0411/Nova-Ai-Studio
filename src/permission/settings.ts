...
const TOOL_NAME_ALIASES = new Map<string, string>([
  ...
  ["WebFetch", "web_fetch"],
  ["FetchPageImages", "fetch_page_images"],
  // PD-SAAS-FORK P0-4/P0-5: canonical permission names for media tools.
  ["FetchMediaAsset", "fetch_media_asset"],
  ["RenderLocalHtmlToImage", "render_local_html_to_image"],
...
export function normalizePermissionSettings(value: unknown): PermissionSettings {
  ...
  return {
    ...
    skipPermissions: typeof record.skipPermissions === 'boolean' ? record.skipPermissions : true,

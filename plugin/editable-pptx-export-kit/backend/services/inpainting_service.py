...
from services.runtime_api_settings import get_runtime_setting
    ...
    def __init__(self, provider=None, provider_type: str = "volcengine"):
        ...
        if provider is None:
            ...
            if provider_type == "gemini":
                ...
                access_key = (
                    get_runtime_setting("VOLCENGINE_ACCESS_KEY", "")
                    or config.VOLCENGINE_ACCESS_KEY
                    or ""
                )
                secret_key = (
                    get_runtime_setting("VOLCENGINE_SECRET_KEY", "")
                    or config.VOLCENGINE_SECRET_KEY
                    or ""
                )
